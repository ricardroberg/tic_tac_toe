"""
Minha terceira tentativa de criar jogo da velha, para duas pessoas.
"""
...
# Transformar de lista para Tupla com Sets
...
while True:
    ...
    # Verifica vitória
    # for v in vence:
    #     if sorted(list(set(v).intersection(jogador1))) == v:
    #         print('JOGADOR 1 VENCEU!')
    #         posicoes.clear()
    #     elif sorted(list(set(v).intersection(jogador2))) == v:
    #         print('JOGADOR 2 VENCEU!')
    #         posicoes.clear()

    for v in vence:
        if v.issubset(set(jogador1)):
            print('JOGADOR 1 VENCEU!')
            posicoes.clear()
        elif v.issubset(set(jogador2)):
            print('JOGADOR 2 VENCEU!')
            posicoes.clear()
    # Acabaram as jogadas
    if len(posicoes) == 0:
